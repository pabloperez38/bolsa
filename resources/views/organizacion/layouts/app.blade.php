                                        ...
                                        <tbody>
                                            ...
                                            <tr class="file-delete">
                                                ...
                                                <td class="center">
                                                    <div id="items_1" class="dropdown titles-dropdown">
                                                        ...
                                                        <ul>
                                                            <li><span class="icon-eye more-ic"></span> <span>View
                                                                    Job</span></li>
                                                            <li class="remove-file"><span
                                                                    class="icon-trash more-ic "></span><span>Remove
                                                                    Job</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex2">
                                                        <div class="images">
                                                            <img src="../images/dashboard/logo-company-2.png"
                                                                alt="">
                                                        </div>
                                                        <div class="content">
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex2">
                                                        <div class="images">
                                                            <img src="../images/dashboard/logo-company-3.png"
                                                                alt="">
                                                        </div>
                                                        <div class="content">
                                            ...
                                            <tr class="file-delete">
                                                <td>
                                                    <div class="candidates-wrap flex2">
                                                        <div class="images">
                                                            <img src="../images/dashboard/logo-company-4.png"
                                                                alt="">
                                                        </div>
                                                        <div class="content">
                                                            <h3>PHP Developer</h3>
